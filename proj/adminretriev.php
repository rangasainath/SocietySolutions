...
<div class="navigation">
    <div class="li"><ul>
<li class="list"><a href="adminindex.php" class="a">HOME</a></li>
<li class="list"><a href="adminretriev.php" class="a">COMPLAINTS</a></li>
</ul>
</div>
</div>
<?php
...
mysqli_close($conn);
?>
<form action="adminlogout.php" method="POST" enctype="multipart/form-data">
